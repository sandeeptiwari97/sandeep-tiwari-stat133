...
So let's make things a bit more interesting. What if you want to calculate some 
...
```{r}
ggplot(gsw, aes(height, weight))+geom_label(aes(label=player))
```
